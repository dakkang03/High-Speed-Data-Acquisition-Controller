...
# Generated on: Thu Oct 30 23:47:42 MDT 2025 (Fri Oct 31 05:47:42 UTC 2025)
...
set logfile logs_Oct30-23:21:11/intermediate2final.lec.log ;# user can modify this name for succeeding runs
...
set_verification_information fv_map_high_speed_daq_controller_mv_db

read_implementation_information fv/high_speed_daq_controller -golden fv_map -revised high_speed_daq_controller_mv
...
read_design -verilog95   -golden -lastmod -noelab fv/high_speed_daq_controller/fv_map.v.gz
elaborate_design -golden -root {high_speed_daq_controller}

read_design -verilog95   -revised -lastmod -noelab outputs_Oct30-23:21:11/high_speed_daq_controller_m.v
elaborate_design -revised -root {high_speed_daq_controller}

#add_name_alias fv/high_speed_daq_controller/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/high_speed_daq_controller/high_speed_daq_controller_mv.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.high_speed_daq_controller.fv_map.high_speed_daq_controller_mv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.high_speed_daq_controller.fv_map.high_speed_daq_controller_mv.rpt
}
report_test_vector -noneq > noneq.test_vector.high_speed_daq_controller.fv_map.high_speed_daq_controller_mv.rpt
